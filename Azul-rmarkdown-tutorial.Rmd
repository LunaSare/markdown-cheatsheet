...
**Symbolic debugger**- interactive program inspector that allows the user to see exactly how the code is executing. This allowing the user to see what is going wrong directly rather than the user having to anticipate the error or asume the error with indirect evidence. 
> Steps from 5-8 have less answers because i havent experimented in those aspects 
 ...
 3. **Make Incremental Changes**
     A - I've Worked in small steps with frequent feedback and course correction - this 
     was more for my statistics class when completing a semester project first we needed
     ...
     manually a description of changes when we are committing our document to git. 
...
-A - document interfaces and reasons, not implementations- This I've done by annotating (#) when coding 
